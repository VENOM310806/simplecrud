...
$dataBank = $master->getUpdateBank($_GET['id']);
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal mengubah data Bank. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Edit Jenis Bank</h3>
							</div>
							<div class="col-sm-6">
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=updateprodi" method="POST">
									    <div class="card-body">
											...
											<div class="mb-3">
												...
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Bank" value="<?php echo $dataBank['nama']; ?>" required>
											</div>
                                        </div>
